...
\section{Awards}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{IAB MIXX Awards '23:} { In-Game Ads Gold Award Turkey } \\ \vspace{3pt}

        \textbf{IAB MIXX Awards '23:} { In-Game Category Europe Finalist.} \\ \vspace{3pt}
        ...
        \textbf{Brandverse Awards '23:} { In-Game Ads Silver Award. } \\ \vspace{3pt}
