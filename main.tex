...
\resumeSubHeadingListStart
    \small{\item{
       ...
       \textbf{Google Introduction to Generative AI Learning Path}  \\ \vspace{3pt}
         \textbf {Coursera Use Python Unit Test to Demonstrate TDD} \\ \vspace{3pt}
         \textbf {Introduction to Microsoft Azure Cloud Services } \\ \vspace{3pt}
         \textbf{BAYKAR Certificate of Contribution in Artificial Intelligence Competition in Transport }  \\ \vspace{3pt}
        \textbf{Meta Back-End Developer Professional Course and Certificate} $|$ \textit{ongoing}  \\ \vspace{3pt}
        \textbf {AZ-104T00 Microsoft Azure Administrator }  $|$ \textit{ongoing} \\ \vspace{3pt}
        
        \textbf{AI-102T00 Designing and Implementing a Microsoft Azure AI Solution} $|$ \textit{ongoing}  \\ \vspace{3pt}
...
\section{Awards}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{LIVAD Studio In-Game Detection System}
           \resumeItemListStart
             \resumeItem {IAB MIXX Awards '23:} { In-Game Ads Gold Award Turkey} \\ \vspace{3pt}
    
             \resumeItem{IAB MIXX Awards '23:} { In-Game Category Europe Finalist.} \\ \vspace{3pt}
              
         \resumeItem{Brandverse Awards '23:} { In-Game Ads Silver Award. } \\ \vspace{3pt}
         \resumeItemListEnd
